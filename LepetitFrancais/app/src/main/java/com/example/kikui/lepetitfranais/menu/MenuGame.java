...
public class MenuGame extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProgressBar pregressBarMemory = (ProgressBar) findViewById(R.id.progressBar);
        TextView memoryPCT = (TextView)findViewById(R.id.memoryPCT);
        ProgressBar pregressBarGame2 = (ProgressBar) findViewById(R.id.progressBar2);
        ...
        game2PCT.setText(String.valueOf(pregressBarGame2.getProgress()+"% "));

        LinearLayout layoutPlayMemory = (LinearLayout) findViewById(R.id.playMenuMemory);
        ...
        LinearLayout layoutPlayGame2 = (LinearLayout) findViewById(R.id.playMenuGame2);
